...
_0x0:
	.DB  0x46,0x61,0x74,0x65,0x6D,0x65,0x20,0x41
	.DB  0x6B,0x72,0x61,0x6D,0x69,0x0,0x39,0x34
	.DB  0x33,0x31,0x38,0x36,0x31,0x31,0x30,0x0
_0x2000003:
	.DB  0x80,0xC0
...
; 0000 0022 DDRC=(1<<DDC7) | (1<<DDC6) | (1<<DDC5) | (1<<DDC4) | (1<<DDC3) | (1<<DDC2) | (1<<DDC1) | (1<<DDC0);
	LDI  R30,LOW(255)
	OUT  0x14,R30
...
; 0000 002C       lcd_gotoxy(0,0);
	...
	LDI  R26,LOW(0)
	RCALL _lcd_gotoxy
; 0000 002D       lcd_putsf("Fateme Akrami");
	__POINTW2FN _0x0,0
	RCALL _lcd_putsf
